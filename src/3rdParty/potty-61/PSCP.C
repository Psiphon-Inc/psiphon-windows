...
{
    printf("PoTTY Secure Copy client\n");
    printf("%s\n", ver);
    printf("Usage: oscp [options] [user@]host:source target\n");
    printf
	("       oscp [options] source [source...] [user@]host:target\n");
    printf("       oscp [options] -ls [user@]host:filespec\n");
    printf("Options:\n");
